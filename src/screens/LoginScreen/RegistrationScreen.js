    ...
    try {
      ...
      if (__DEV__) {
        ...
        console.log('[API Log] Request Headers:', {
          ...
          'Authorization': `Bearer ${token.slice(0, 10)}...` // Only log part of the token for security
        });
      ...
      // Send registration data to the API using PUT method
      ...
      if (response.ok) {
        ...
        // Store user account ID if available in the response
        ...
        // Simple solution - just navigate back to previous screen (likely the Login screen)
