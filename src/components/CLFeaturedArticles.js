...
const CLFeaturedArticles = ({ articles, contentType, language, navigation, onViewAll }) => {
        ...
        {articles.length > 0 ? (
          articles.map((article, index) => (
            <TouchableOpacity 
              ...
              onPress={() => {
                navigation && navigation.navigate('CLArticleDetail', { article });
              }}
            >
...
export default CLFeaturedArticles;