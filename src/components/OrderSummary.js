...
const OrderSummary = ({ cart, subtotal, showDeliveryFee, deliveryFee, taxes, totalPrice }) => {
  ...
  const renderOrderItem = (item) => {
    ...
    if (__DEV__) {  // Log in development mode only
      ...
      console.log('[Order Summary Log] Revceived Item Selected Option:', item.selectedOption);
      console.log('[Order Summary Log] Revceived Item Selected Modifiers:', item.selectedModifiers);
    }
