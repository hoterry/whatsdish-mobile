...
function HomeTabs({ setIsAuthenticated }) {
  console.log("setIsAuthenticated in HomeTabs:", setIsAuthenticated);  // 確認這裡是否為 undefined
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
    ...
    >
      ...
      <Tab.Screen name="Account">
        {props => {
          console.log("setIsAuthenticated in AccountScreen:", setIsAuthenticated);  // 確保這裡有 setIsAuthenticated
...
function AppStack({ setIsAuthenticated }) {
  return (
    <Stack.Navigator>
      <Stack.Screen name="HomeTabs" component={HomeTabs} options={{ headerShown: false }} setIsAuthenticated={setIsAuthenticated} />
