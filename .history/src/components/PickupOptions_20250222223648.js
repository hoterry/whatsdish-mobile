...
const PickupOptions = ({
  ...
  useEffect(() => {
    if (__DEV__) {
      console.log("[Pickup Option Log] Received restaurantId :", restaurantId); // Log restaurantId
      console.log("[Pickup Option Log] Received restaurants :", restaurants); // Log the entire restaurants array
    }
