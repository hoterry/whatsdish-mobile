...
const DeliveryOptions = ({
  ...
  const handlePickupTimeConfirm = (time) => {
    ...
    onPickupOptionChange('scheduled'); // 先更新选项
    onPickupTimeChange(time); // 更新选定的时间
  };
  
  const handleDeliveryTimeConfirm = (time) => {
    setSelectedTime(time);
    onDeliveryOptionChange('scheduled'); // 确保 delivery 也有 scheduled 选项
        ...
        <View>
          ...
          <View style={styles.timeOptionContainer}>
            ...
            <TouchableOpacity
              style={[
                styles.timeOption,
                deliveryOption === 'scheduled' ? styles.selectedTime : styles.deselectedTime,
              ]}
              onPress={() => {
                onDeliveryOptionChange('scheduled'); // 确保更新 deliveryOption
                openScheduleModal();
              }}
            >
              <Text style={styles.timeText}>Schedule</Text>
