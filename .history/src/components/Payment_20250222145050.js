    ...
    const fetchSavedCards = async () => {
      ...
      try {
        ...
        if (data?.cards?.length > 0) {
          ...
          console.log('Default card selected:', defaultCard);
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {loading ? (
          ...
          <TouchableOpacity style={styles.paymentContainer} onPress={() => {
            console.log('Opening payment method selection modal');
        ...
        <Modal visible={modalVisible} transparent animationType="slide">
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              <PaymentMethod onSelectMethod={handleSelectMethod} onClose={() => {
                console.log('Closing payment method selection modal');
                setModalVisible(false);
              }} />
            </View>
          </View>
