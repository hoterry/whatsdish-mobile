        ...
        <>
          ...
          <View style={styles.header}>
            <Text style={styles.sectionHeader}>
              {language === 'ZH' ? '選擇付款方式' : 'Select Payment Method'} {/* 根據語言顯示不同標題 */}
            </Text>
          ...
          {savedCards.length > 0 ? (
            ...
            <Text style={styles.noSavedCardText}>
              {language === 'ZH' ? '沒有儲存的付款方式' : 'No saved payment methods.'} {/* 顯示相應的文本 */}
            </Text>
          )}
          ...
          <TouchableOpacity style={styles.addPaymentButton} onPress={() => setIsAddingCard(true)}>
            ...
            <Text style={styles.addPaymentText}>
              {language === 'ZH' ? '新增付款方式' : 'Add payment method'} {/* 顯示相應的文本 */}
            </Text>
          </TouchableOpacity>
        </>
      )}
