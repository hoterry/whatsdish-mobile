...
const ScheduleModal = ({
  ...
  useEffect(() => {
    if (isVisible) {
      setSelectedDate(new Date(currentTime)); // Set initial date
      setSelectedTime(new Date(currentTime)); // Set initial time
    }
        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.pickerContainer}>
            ...
            <TouchableOpacity onPress={() => setShowDatePicker(true)} style={styles.picker}>
              <Text style={styles.pickerItem}>{formatDate(selectedDate)}</Text>
            </TouchableOpacity>
            {showDatePicker && (
              <DateTimePicker
                value={selectedDate}
