        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.pickerContainer}>
            ...
            <Picker
              ...
              mode={Platform.OS === 'ios' ? 'dropdown' : 'dialog'} // 根據平台設置 mode
            >
...
const styles = StyleSheet.create({
  ...
  picker: {
    ...
    borderWidth: 1,
    borderColor: '#ddd',
    height: Platform.OS === 'ios' ? 120 : 60, // Increase height for a better scroll effect
  },
  pickerItem: {
    fontSize: 16, //统一设置 Picker.Item 的字体大小
  },
  confirmButton: {
