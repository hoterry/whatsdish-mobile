              ...
              <View style={styles.tagContainer}>
                {item.pickup && (
                  <View style={styles.tag}>
                    ...
                    <Text style={styles.tagText}>{t('pickUp')}</Text> {/* Use translation here */}
                  </View>
                )}
                {item.delivery && (
                  <View style={styles.tag}>
                    <Ionicons name="checkmark-circle" size={14} color="green" />
                    <Text style={styles.tagText}>{t('delivery')}</Text> {/* Use translation here */}
                  </View>
                )}
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  discountTag: {
    ...
    paddingHorizontal: 6,  // 调小水平内边距
    paddingVertical: 3,  // 调小垂直内边距
    borderRadius: 4,
    zIndex: 1,
    width: 60,  // 调小宽度
    height: 25,  // 调小高度
