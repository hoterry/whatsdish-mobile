        ...
        <View>
          ...
          <View style={styles.pickupTimeContainer}>
            ...
            <Text style={styles.pickupTimeText}>
              Pickup Time: {formatSelectedTime(selectedTime || pickupScheduledTime)}
            </Text>
          </View>
          ...
          <View style={styles.timeOptionContainer}>
            <TouchableOpacity
              style={[
                ...
                pickupOption === 'immediate' && styles.selectedBorder, // Standard 選中時添加黑色邊框
              ]}
            ...
            <TouchableOpacity
              style={[
                ...
                pickupOption === 'scheduled' && styles.selectedBorder, // Schedule 選中時添加黑色邊框
              ]}
