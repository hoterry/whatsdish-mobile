...
const ScheduleModal = ({
  ...
  const [selectedTime, setSelectedTime] = useState(null); // Initialize as null to ensure it's a Date object later

  useEffect(() => {
    if (isVisible) {
      setSelectedDate(''); // Clear the date and time when the modal opens
