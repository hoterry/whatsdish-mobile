...
const styles = StyleSheet.create({
  ...
  flatListContainer: {
    paddingTop: 80, // Ensure content starts after the header, leave room for the header height
  ...
  headerContainer: {
    ...
    paddingTop: 40, // Set paddingTop to ensure header stays fixed
    paddingHorizontal: 20,
    backgroundColor: '#fff',
    elevation: 5,
    shadowColor: '#000',
  ...
  header: {
    ...
    right: 0,
    textAlign: 'center',
    top: 20, // Adjust the vertical position of the header text
  },
  backButton: {
    position: 'absolute',
    left: 20,
    top: 20, // Align the back button to the top
    zIndex: 10,
  },
  orderItem: {
    padding: 15,
