...
function OrderHistoryScreen() {
  ...
  const renderEmptyComponent = () => (
    <View style={styles.emptyContainer}>
      <Image
        source={{ uri: 'https://res.cloudinary.com/dfbpwowvb/image/upload/v1733574455/no_orders_icon.png' }} // 可以放置一個沒有訂單的圖片
        style={styles.emptyImage}
      />
      <Text style={styles.emptyText}>
        {language === 'ZH' ? '還沒有訂單' : 'No orders yet'}
      </Text>
    </View>
  );
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <View style={styles.logoContainer}>
                <Image source={{ uri: 'https://res.cloudinary.com/dfbpwowvb/image/upload/v1733574455/342534_m5opy3.png' }} style={styles.restaurantLogo} />
              </View>
              <View style={styles.orderDetails}>
                {/* 顯示餐廳名稱（大字體） */}
                <Text style={styles.restaurantName}>
                  {item.restaurantName || 'Peaches Cafe Richmond'} {/* 如果沒有餐廳名稱則顯示 '餐廳名稱' */}
                </Text>
...
const styles = StyleSheet.create({
  ...
  emptyImage: { width: 100, height: 100, marginBottom: 16 },
