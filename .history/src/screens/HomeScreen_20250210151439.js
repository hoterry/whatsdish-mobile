...
const HomeScreen = () => {
  ...
  const handleLanguageChange = (newLanguage) => {
    ...
    Alert.alert('Language Changed', `Language is now set to ${newLanguage}`); // 提示用户
  };
            ...
            <View style={styles.topBarRow}>
              ...
              <View style={styles.iconContainer}>
                ...
                <TouchableOpacity onPress={() => setShowLanguageModal(true)} style={styles.languageContainer}>
                  <Ionicons name="volume-high" size={24} color="black" /> {/* 语音图标 */}
                  <Text style={styles.languageText}>{language}</Text> {/* 当前语言 */}
                </TouchableOpacity>
              </View>
            </View>
            <View style={styles.topBarRow}>
