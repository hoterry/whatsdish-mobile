...
import { View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, TextInput, SafeAreaView, Modal, Platform } from 'react-native';
...
import AddressPicker from '../components/AddressPicker';  // 引入地址選擇器
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <View style={styles.fixedHeader}>
            <View style={styles.topBar}>
              ...
              <View style={styles.topBarRow}>
                <TouchableOpacity style={styles.location} onPress={() => setPickerVisible(true)}>
          ...
          <Modal visible={isPickerVisible} animationType="fade" transparent={true}>
