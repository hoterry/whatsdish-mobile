  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        {/* Display Account ID and Language Preference */}
        <InfoRow label="Account ID" value={userData.accountId || 'N/A'} isEditable={false} />
        <InfoRow label="Language Preference" value={userData.languagePreference || 'N/A'} isEditable={false} />
