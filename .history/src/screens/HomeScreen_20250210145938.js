...
import { View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, TextInput, ActivityIndicator, StatusBar  } from 'react-native';
...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 80 }}> {/* 添加 paddingBottom 避免内容被底部导航栏遮挡 */}
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    marginTop: StatusBar.currentHeight || 0, // 动态设置顶部边距
    backgroundColor: "#FFF"
  },
  logo: {
    width: 200,
