...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}> {/* 使用 edges 属性控制安全区域 */}
      <View style={styles.container}>
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: Platform.OS === 'android' ? 120 : 80 }}> {/* 增加 Android 的 paddingBottom */}
