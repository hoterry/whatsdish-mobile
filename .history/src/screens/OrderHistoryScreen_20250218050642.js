...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    paddingTop: 150, // Padding to align header properly with the back button
    paddingHorizontal: 20,
    backgroundColor: '#fff',
    elevation: 5,
    shadowColor: '#000',
  ...
  header: {
    ...
    right: 0,
    textAlign: 'center',
    paddingTop: 50, // Align header title with the back button
  },
  backButton: {
    position: 'absolute',
    left: 20,
    paddingTop: 50, // Align back button with the header
    zIndex: 10,
  },
  orderItem: {
    padding: 15,
