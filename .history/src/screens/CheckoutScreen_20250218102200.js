...
import PlaceOrderButton from '../components/PlaceOrderButton';  // 引入拆分出的組件
...
function CheckoutScreen({ route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* 使用拆分出來的 PlaceOrderButton 組件 */}
      <PlaceOrderButton orderData={orderData} clearCart={clearCart} language={language} />
    </View>
  );
}
