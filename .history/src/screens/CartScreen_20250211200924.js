    ...
    return (
      <View style={styles.cartItem} key={key}>
        ...
        <Text style={styles.cartItemName}>
          ...
          {/* Display selected options (e.g., Size) */}
          {item.selectedOption && (
            <View style={styles.selectedOptionContainer}>
              ...
              <Text style={styles.selectedOptionText}>
                {language === 'ZH' ? item.selectedOption.name_zh : item.selectedOption.name} {/* Render Option Name based on language */}
                (${item.selectedOption.price})
              </Text>
            </View>
          )}
  
          {/* Display selected modifiers (e.g., additional toppings) */}
            ...
            <View style={styles.modifiersContainer}>
              ...
              {item.selectedModifiers.map((modifier, index) => (
                <Text key={index} style={styles.modifierText}>
                  {language === 'ZH' ? modifier.name_zh : modifier.name} {/* Render Modifier Name based on language */}
                  (+${modifier.price})
                </Text>
              ))}
            </View>
