...
import { LanguageContext } from '../context/LanguageContext'; // 導入 LanguageContext
...
const HomeScreen = () => {
  ...
  const { language, changeLanguage } = useContext(LanguageContext); // 使用語言上下文
  ...
  const handleLanguageChange = (newLanguage) => {
    ...
    Alert.alert(t('languageChanged'), `Language is now set to ${newLanguage}`);
  };
