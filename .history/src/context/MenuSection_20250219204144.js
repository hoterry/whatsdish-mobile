      ...
      if (index === 30 && itemIndex === 30) {
        ...
        return (
          ...
          >
            ...
            <Image source={{ uri: menuItem.image_url || 'default-image-url' }} style={styles.image} />
            <TouchableOpacity
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        initialNumToRender={10} // 初始渲染的項目數量
        maxToRenderPerBatch={10} // 每批次渲染的最大項目數量
        windowSize={5} // 預渲染區域的大小（單位是屏幕）
        removeClippedSubviews={true} // 移除不可見區域的子視圖，以節省內存
      />
