  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log('[Fetch User Log] Fetched Data:', data);  // Log the raw data from the response
        ...
        if (response.ok) {
          ...
          setUserData(user);
          console.log('[Fetch User Log] Updated user data:', user);  // Log the updated user data
        } else {
