...
import * as Font from 'expo-font';  // 引入 Font 模塊
import { AppLoading } from 'expo';  // 引入 AppLoading
...
export default function App() {
  ...
  const [fontsLoaded, setFontsLoaded] = useState(false); // 新增狀態以處理字體加載
